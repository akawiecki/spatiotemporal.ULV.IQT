...
data.bio <-  readRDS(here("analysis", "data", "derived_data", "variables", "variables_2013", "vbles.space.ring.bio.13.rds"))%>% 
  mutate(month= as.factor(month))

data.100m <-  readRDS(here("analysis", "data", "derived_data", "variables", "variables_2013", "vbles.space.ring.100m.13.rds"))%>% 
  mutate(month= as.factor(month))
...
m.sur.rings.list.2013 <- flatten(list(m.rings.bio, m.rings.100m))

saveRDS(m.sur.rings.list.2013 , here("analysis", "data", "derived_data", "model", "model_2013", "model_outputs_2013", "m.space.rings.13.rds"))
