...
df <-  readRDS(here("analysis", "data", "derived_data", "variables", "variables_2013",  "vbles.space.decay.13.rds"))
...
saveRDS(m.priors , here("analysis", "data", "derived_data", "model", "model_2013", "model_outputs_2013", "m.priors.13.rds"))

m.priors.fe <-  fx.fe.prior(m.priors) 
m.priors.waic <- fx.waic.prior(m.priors)

saveRDS(m.priors.fe , here("analysis", "data", "derived_data", "model", "model_2013", "model_outputs_2013", "fe.priors.13.rds"))
saveRDS(m.priors.waic, here("analysis", "data", "derived_data", "model", "model_2013", "model_outputs_2013", "waic.priors.13.rds"))
```
