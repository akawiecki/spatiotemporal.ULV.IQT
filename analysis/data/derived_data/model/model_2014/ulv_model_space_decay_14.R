...
data <- readRDS(here("analysis", "data", "derived_data", "variables", "variables_2014", "vbles.space.decay.14.rds"))
...
m.sur.list.2014 <- fx.model.2fe(df= data, vble.list= l.variables.decay, ncores= cores)

saveRDS(m.sur.list.2014 , here("analysis", "data", "derived_data", "model", "model_2014", "model_outputs_2014", "m.space.decay.14.rds"))
