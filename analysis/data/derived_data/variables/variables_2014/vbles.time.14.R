...
data.14 <- data %>% 
  ...
  # selects only data from the 2014 experiment
  filter(exp=="2014") %>% 
...
data.14 <- data.14 %>% 
  ...
  mutate(
    ...
    day.min = do.call(pmin, c(data.14[, c("diff_c1", "diff_c2", "diff_c3", "diff_c4", "diff_c5", "diff_c6")], list(na.rm = TRUE))),
    # w.min= weeks since the most recent spray
    w.min = do.call(pmin, c(data.14[, c("w_c1", "w_c2", "w_c3", "w_c4", "w_c5", "w_c6")], list(na.rm = TRUE))),
    # i_day.max= inverse weight of the most recent spray
    i_day.max = do.call(pmax, c(data.14[, c("i_day1", "i_day2", "i_day3", "i_day4", "i_day5", "i_day6")], list(na.rm = TRUE)))
  ) %>%
  mutate(
    # assign a weight to the difference in time between the spray event and the adult survey
...
data.14 <- data.14 %>% 
  ...
  mutate(n.spray.by.date = 6 - rowSums(is.na(data.14[, c("diff_c1", "diff_c2", "diff_c3", "diff_c4", "diff_c5", "diff_c6")]))) %>%
  ...
  mutate(
    i_day = rowSums(data.14[,c("i_day1", "i_day2", "i_day3", "i_day4","i_day5", "i_day6")], na.rm = TRUE), 
    e0.005_day= rowSums(data.14[,c("e0.005_day1", "e0.005_day2", "e0.005_day3", "e0.005_day4", "e0.005_day5", "e0.005_day6")], na.rm = TRUE),
    e0.01_day= rowSums(data.14[,c("e0.01_day1", "e0.01_day2", "e0.01_day3", "e0.01_day4", "e0.01_day5", "e0.01_day6")], na.rm = TRUE),
    e0.015_day= rowSums(data.14[,c("e0.015_day1", "e0.015_day2", "e0.015_day3", "e0.015_day4", "e0.015_day5", "e0.015_day6")], na.rm = TRUE),
    e0.02_day= rowSums(data.14[,c("e0.02_day1", "e0.02_day2", "e0.02_day3", "e0.02_day4", "e0.02_day5", "e0.02_day6")], na.rm = TRUE),
    e0.03_day= rowSums(data.14[,c("e0.03_day1", "e0.03_day2", "e0.03_day3", "e0.03_day4", "e0.03_day5", "e0.03_day6")], na.rm = TRUE),
    e0.04_day= rowSums(data.14[,c("e0.04_day1", "e0.04_day2", "e0.04_day3", "e0.04_day4", "e0.04_day5", "e0.04_day6")], na.rm = TRUE),
    e0.06_day= rowSums(data.14[,c("e0.06_day1", "e0.06_day2", "e0.06_day3", "e0.06_day4", "e0.06_day5", "e0.06_day6")], na.rm = TRUE),
    e0.1_day= rowSums(data.14[,c("e0.1_day1", "e0.1_day2", "e0.1_day3", "e0.1_day4", "e0.1_day5", "e0.1_day6")], na.rm = TRUE),
    e0.2_day= rowSums(data.14[,c("e0.2_day1", "e0.2_day2", "e0.2_day3", "e0.2_day4", "e0.2_day5", "e0.2_day6")], na.rm = TRUE),
    e0.4_day= rowSums(data.14[,c("e0.4_day1", "e0.4_day2", "e0.4_day3", "e0.4_day4", "e0.4_day5", "e0.4_day6")], na.rm = TRUE),
    e1_day= rowSums(data.14[,c("e1_day1", "e1_day2", "e1_day3", "e1_day4", "e1_day5", "e1_day6")], na.rm = TRUE),
    
    #g1_day= rowSums(data.14[,c("g1_day1", "g1_day2", "g1_day3", "g1_day4", "g1_day5", "g1_day6")], na.rm = TRUE)
    g1_day= rowSums(data.14[,c("g1_day1", "g1_day2", "g1_day3", "g1_day4", "g1_day5", "g1_day6")], na.rm = TRUE),
    g3_day= rowSums(data.14[,c("g3_day1", "g3_day2", "g3_day3", "g3_day4", "g3_day5", "g3_day6")], na.rm = TRUE),
    g5_day= rowSums(data.14[,c("g5_day1", "g5_day2", "g5_day3", "g5_day4", "g5_day5", "g5_day6")], na.rm = TRUE),
    g7_day= rowSums(data.14[,c("g7_day1", "g7_day2", "g7_day3", "g7_day4", "g7_day5", "g7_day6")], na.rm = TRUE),
    g10_day= rowSums(data.14[,c("g10_day1", "g10_day2", "g10_day3", "g10_day4", "g10_day5", "g10_day6")], na.rm = TRUE),
    g15_day= rowSums(data.14[,c("g15_day1", "g15_day2", "g15_day3", "g15_day4", "g15_day5", "g15_day6")], na.rm = TRUE),
    g20_day= rowSums(data.14[,c("g20_day1", "g20_day2", "g20_day3", "g20_day4", "g20_day5", "g20_day6")], na.rm = TRUE),
    g25_day= rowSums(data.14[,c("g25_day1", "g25_day2", "g25_day3", "g25_day4", "g25_day5", "g25_day6")], na.rm = TRUE),
    g30_day= rowSums(data.14[,c("g30_day1", "g30_day2", "g30_day3", "g30_day4", "g30_day5", "g30_day6")], na.rm = TRUE),
    g35_day= rowSums(data.14[,c("g35_day1", "g35_day2", "g35_day3", "g35_day4", "g35_day5", "g35_day6")], na.rm = TRUE),
    g40_day= rowSums(data.14[,c("g40_day1", "g40_day2", "g40_day3", "g40_day4", "g40_day5", "g40_day6")], na.rm = TRUE),
    g50_day= rowSums(data.14[,c("g50_day1", "g50_day2", "g50_day3", "g50_day4", "g50_day5", "g50_day6")], na.rm = TRUE),
    g60_day= rowSums(data.14[,c("g60_day1", "g60_day2", "g60_day3", "g60_day4", "g60_day5", "g60_day6")], na.rm = TRUE),
    g80_day= rowSums(data.14[,c("g80_day1", "g80_day2", "g80_day3", "g80_day4", "g80_day5", "g80_day6")], na.rm = TRUE)
    
  ) %>%
  
  #find weight value for most recent spray
  
  mutate(
    
    e0.005_day.max= do.call(pmax, c(data.14[,c("e0.005_day1", "e0.005_day2", "e0.005_day3", "e0.005_day4", "e0.005_day5", "e0.005_day6")], list(na.rm=TRUE))),
    e0.01_day.max= do.call(pmax, c(data.14[,c("e0.01_day1", "e0.01_day2", "e0.01_day3", "e0.01_day4", "e0.01_day5", "e0.01_day6")], list(na.rm=TRUE))),
    e0.015_day.max= do.call(pmax, c(data.14[,c("e0.015_day1", "e0.015_day2", "e0.015_day3", "e0.015_day4", "e0.015_day5", "e0.015_day6")], list(na.rm=TRUE))),
    e0.02_day.max= do.call(pmax, c(data.14[,c("e0.02_day1", "e0.02_day2", "e0.02_day3", "e0.02_day4", "e0.02_day5", "e0.02_day6")], list(na.rm=TRUE))),
    e0.03_day.max= do.call(pmax, c(data.14[,c("e0.03_day1", "e0.03_day2", "e0.03_day3", "e0.03_day4", "e0.03_day5", "e0.03_day6")], list(na.rm=TRUE))),
    e0.04_day.max= do.call(pmax, c(data.14[,c("e0.04_day1", "e0.04_day2", "e0.04_day3", "e0.04_day4", "e0.04_day5", "e0.04_day6")], list(na.rm=TRUE))),
    e0.06_day.max= do.call(pmax, c(data.14[,c("e0.06_day1", "e0.06_day2", "e0.06_day3", "e0.06_day4", "e0.06_day5", "e0.06_day6")], list(na.rm=TRUE))),
    e0.1_day.max= do.call(pmax, c(data.14[,c("e0.1_day1", "e0.1_day2", "e0.1_day3", "e0.1_day4", "e0.1_day5", "e0.1_day6")], list(na.rm=TRUE))),
    e0.2_day.max= do.call(pmax, c(data.14[,c("e0.2_day1", "e0.2_day2", "e0.2_day3", "e0.2_day4", "e0.2_day5", "e0.2_day6")], list(na.rm=TRUE))),
    e0.4_day.max= do.call(pmax, c(data.14[,c("e0.4_day1", "e0.4_day2", "e0.4_day3", "e0.4_day4", "e0.4_day5", "e0.4_day6")], list(na.rm=TRUE))),
    e1_day.max= do.call(pmax, c(data.14[,c("e1_day1", "e1_day2", "e1_day3", "e1_day4", "e1_day5", "e1_day6")], list(na.rm=TRUE))),
    
    g1_day.max= do.call(pmax, c(data.14[,c("g1_day1", "g1_day2", "g1_day3", "g1_day4", "g1_day5", "g1_day6")], list(na.rm=TRUE))),
    g3_day.max= do.call(pmax, c(data.14[,c("g3_day1", "g3_day2", "g3_day3", "g3_day4", "g3_day5", "g3_day6")], list(na.rm=TRUE))),
    g5_day.max= do.call(pmax, c(data.14[,c("g5_day1", "g5_day2", "g5_day3", "g5_day4", "g5_day5", "g5_day6")], list(na.rm=TRUE))),
    g7_day.max= do.call(pmax, c(data.14[,c("g7_day1", "g7_day2", "g7_day3", "g7_day4", "g7_day5", "g7_day6")], list(na.rm=TRUE))),
    g10_day.max= do.call(pmax, c(data.14[,c("g10_day1", "g10_day2", "g10_day3", "g10_day4", "g10_day5", "g10_day6")], list(na.rm=TRUE))),
    g15_day.max= do.call(pmax, c(data.14[,c("g15_day1", "g15_day2", "g15_day3", "g15_day4", "g15_day5", "g15_day6")], list(na.rm=TRUE))),
    g20_day.max= do.call(pmax, c(data.14[,c("g20_day1", "g20_day2", "g20_day3", "g20_day4", "g20_day5", "g20_day6")], list(na.rm=TRUE))),
    g25_day.max= do.call(pmax, c(data.14[,c("g25_day1", "g25_day2", "g25_day3", "g25_day4", "g25_day5", "g25_day6")], list(na.rm=TRUE))),
    g30_day.max= do.call(pmax, c(data.14[,c("g30_day1", "g30_day2", "g30_day3", "g30_day4", "g30_day5", "g30_day6")], list(na.rm=TRUE))),
    g35_day.max= do.call(pmax, c(data.14[,c("g35_day1", "g35_day2", "g35_day3", "g35_day4", "g35_day5", "g35_day6")], list(na.rm=TRUE))),
    g40_day.max= do.call(pmax, c(data.14[,c("g40_day1", "g40_day2", "g40_day3", "g40_day4", "g40_day5", "g40_day6")], list(na.rm=TRUE))),
    g50_day.max= do.call(pmax, c(data.14[,c("g50_day1", "g50_day2", "g50_day3", "g50_day4", "g50_day5", "g50_day6")], list(na.rm=TRUE))),
    g60_day.max= do.call(pmax, c(data.14[,c("g60_day1", "g60_day2", "g60_day3", "g60_day4", "g60_day5", "g60_day6")], list(na.rm=TRUE))),
    g80_day.max= do.call(pmax, c(data.14[,c("g80_day1", "g80_day2", "g80_day3", "g80_day4", "g80_day5", "g80_day6")], list(na.rm=TRUE)))
...
data.14 <-  data.14 %>% 
  ...
  # we DO count spray on the same day in L-2014, adult surveys were typically carried out 1 to 4 days AFTER a house was sprayed (Gunning2018)
  
  # make an interval for the days 1-6 weeks before
  mutate(interval1= interval(ymd(date- 7),ymd(date)), 
...
# turn data.14 into an sf object again
data.14 <- st_as_sf(data.14 , coords= c("lat","long"), crs= st_crs(32718))


saveRDS(data.14, here("analysis", "data", "derived_data", "variables","variables_2014", "vbles.time.14.rds"))
